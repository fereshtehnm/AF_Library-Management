    ...
    <div class="card">
        <div class="w-32 m-8">
            <a href="{{ url('staff/create') }}">
                <button type="button" class="btn btn-sm btn-secondary waves-effect waves-light">Add new staff</button>
            </a>
        </div>
                                ...
                                <div class="">
                                    ...
                                    <form method="POST" action="{{ route('staff.delete', ['staff' => $staff]) }}"
                                        ...
                                        <button type="submit" class="btn btn-danger">
                                            <svg class="remove" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                                                width="16" height="16">
                                                <path
