                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-end d-flex align-items-end justify-content-center">
                            <div class="card-body pb-0 pt-3 position-absolute bottom-0">
                                <img src="../../assets/img/illustrations/card-ratings-illustration.png" alt="Ratings"
                                    width="95" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card h-100">
                    <div class="row">
                        ...
                        <div class="col-6 text-end d-flex align-items-end justify-content-center">
                            <div class="card-body pb-0 pt-3 position-absolute bottom-0">
                                <img src="../../assets/img/illustrations/card-session-illustration.png" alt="Ratings"
                                    width="81" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-2 my-md-0 text-center">
                                    <img src="../../assets/img/products/card-weekly-sales-watch.png" alt="weekly sales"
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="ps-0">
                                                    <img src="../../assets//img/products/samsung-s22.png" alt="samsung"
                                                        class="rounded" height="34" />
                                                </td>
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <img src="../../assets//img/products/oneplus-9-pro.png" alt="us-flag"
                                                        class="rounded" height="34" />
                                                </td>
                                                <td class="text-heading fw-semibold ps-0">Oneplus 9 Pro</td>
                                                <td class="text-heading text-end pe-0">
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <img src="../../assets//img/products/hp-envy-x360.png" alt="hp-envy"
                                                        class="rounded" height="34" />
                                                </td>
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="ps-0">
                                                    <img src="../../assets//img/products/xbox-series-x.png" alt="xbox"
                                                        class="rounded" height="34" />
                                                </td>
                ...
                <div class="swiper-container swiper-container-horizontal swiper swiper-sales" id="swiper-marketing-sales">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide pb-3">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                <img src="../../assets//img/products/card-accounting-logo.png" alt="Marketing and sales"
                                    width="84" class="rounded" />
                                <div class="d-flex flex-column w-100 ms-4">
