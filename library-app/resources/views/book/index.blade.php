    ...
    <div class="row mb-5">
        ...
        @foreach ($books as $book)
            <div class="col-md-3 col-sm-4">
                ...
                @endphp
                <img class="card-img-top" src="{{ asset('assets/img/elements/' . $randomImage->getFilename()) }}" alt="Card image cap" style="width:298px;height:150px;"/>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('book.delete', ['book' => $book->id]) }}"
                            ...
                            <div class="w-32 m-8">
                                ...
                                <button type="button" class="btn btn-sm btn-secondary waves-effect waves-light d-right" data-bs-toggle="modal" data-bs-target="#dateTimeModal">Borrow book</button>
